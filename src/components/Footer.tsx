...
const navigation = {
  solutions: [
    { name: 'Infrastructure Guarding', href: '/services/infrastructure-guarding' },
  ...
  industries: [
    ...
    { name: 'Government (LGUs)', href: '/industries/government' },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Delivering innovative security solutions that protect your assets, infrastructure, and data. Your trusted partner in comprehensive security management.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <a href="tel:+1800123456" className="text-sm leading-6 text-gray-300 hover:text-white flex items-center">
                  ...
                  <li>
                    <a href="mailto:info@infraguard.com" className="text-sm leading-6 text-gray-300 hover:text-white flex items-center">
                      <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li>
                    <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-sm leading-6 text-gray-300 hover:text-white flex items-center">
                      <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} InfraGuard Technologies. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
